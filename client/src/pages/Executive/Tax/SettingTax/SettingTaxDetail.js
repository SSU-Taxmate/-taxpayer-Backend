...
function SettingTaxDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get("/api/taxes", {
    ...
    () => (
      ...
      >
        ...
        >
          ...
          <option name="culture" value="culture">
            문화비
          </option>
    ...
    <>
      {isLoading ? (
        ...
        data && (
          <>
            <div
              className="account-card shadow bg-white mb-3"
              style={{ display: "flex" }}
            >
              <form
                style={{
              ...
              >
                ...
                <div className="row mb-3">
                  <div className="col">
                    ...
                    >
                      <p className="h5 mb-3">
                        직접세 &nbsp;
                        <Popover id="직접세설명" icon="info-circle">
                          직접세 설명을 적어봅시다
                        </Popover>
                      </p>
                      <button
                ...
                <div className="row mb-3">
                  <div className="col">
                    <p className="h5 mb-3">
                      간접세&nbsp;
                      <Popover id="간접세설명" icon="info-circle">
                        간접세 설명을 적어봅시다
                      </Popover>
                    </p>
                    <InputTax
                ...
                <p className="h5 mb-3">
                  벌금 &nbsp;
                  <Popover id="벌금정보" icon="info-circle">
                    벌금 탭에서 자세한 내용 확인하세요
                  </Popover>
                </p>
              </form>
