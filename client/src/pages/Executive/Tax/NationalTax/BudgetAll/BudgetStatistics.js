...
function BudgetStatistics() {
    ...
    const fetchData = async () => {
        ...
        setIsLoading(true);
        try {
            const result = await axios.get('/api/budget/history', { params: { classId: classData.classId } });
    ...
    return (
        <div className="col-md-8">
            <div className="card py-1 border-0" style={{ justifyContent: 'space-evenly' }}>
