...
const iconSet = [
  { icon: "caret-up", color: "red" },
  { icon: "caret-down", color: "blue" },
];
function StockList({ data }) {
  return (
    <div>
      <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 flex-nowrap overflow-auto">
        {data.map((item, i) => (
                  ...
                  <div className="col">
                    ...
                    <div className="row ml-2">
                      <div className="h5 mb-0 font-weight-bold text-gray-800">
                        {item.prices[item.prices.length - 1].value}
                      </div>
                      <div className="row">
