...
function Statistics() {
    ...
    const fetchData = async () => {
        ...
        setIsLoading(true);
        try {
            const result = await axios.get(`/api/students/${joinedUser.classUser}/account/statistics`, { params: { startDate: startdate, endDate: moment(enddate).add(1, 'd').format('YYYY-MM-DD') } })
