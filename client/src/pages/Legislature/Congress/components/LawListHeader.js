...
export default function LawListHeader(props) {
  ...
  return (
    <div>
      <div className="row mt-3 mb-3 no-gutters align-items-center mx-2 justify-content-end">
        <div className="col-auto h6 mb-0 text-gray-800 font-weight-bold mr-1">
          <Autocomplete
            id="list-sorting"
            options={sorting}
        ...
        <div className="col-auto h6 mb-0 mr-2 text-gray-800 font-weight-bold ml-1">
      ...
      <div className="card-body d-none d-sm-inline">
        <div className="row no-gutters align-items-center mx-4">
          <div className="col-2 mr-2">
            <div className="h6 mb-0 text-gray-800 font-weight-bold">만료일</div>
          </div>
          <div className="col mr-2">
            <div className="h6 mb-0 text-gray-800 font-weight-bold text-center">
              제목
            </div>
          </div>
