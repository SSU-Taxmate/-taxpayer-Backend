      ...
      <div className=" bg-gradient bg-primary">
        ...
        <div className="bg-white py-2">
          <div className="container">
            ...
            <div className="row row-cols-1 mt-3 mb-4 justify-content-center">
          ...
          <div className="container bg-white pt-3">
            <div className="row row-cols-1 justify-content-center">
              <div className="col-md-7 mt-5 text-gray-900">
                ...
                <h4 className="mb-4 mt-3">&nbsp; 부자되는 습관 기르기!</h4>
                <p className="p-2 h5" style={{ lineHeight: "200%" }}>
                  스스로 돈도 벌고! 쓰고! 저축하고! 투자하고!<br></br>
                  Taxmate 만의 특별한 은행 ( 계좌 / 예금 ) 서비스를<br></br>
                  이용해보세요!
                </p>
              </div>
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-md-7  text-gray-900 mt-5 mb-5">
                <div className="py-3 pl-5">
                  ...
                  <h4 className="mb-4 mt-2" style={{ lineHeight: "200%" }}>
                    {" "}
                    간단하고 재미있는 학급 모의 주식!{" "}
                  </h4>
                  <p className="p-2 h5 mb-4 " style={{ lineHeight: "200%" }}>
        ...
        >
          <h3>
            <span style={{ fontWeight: "bold", color: "blue" }}>TaxMate</span>와
            함께하는 즐거운 학급 경영!<br></br>
            <br></br> 지금 바로{" "}
            <span style={{ fontWeight: "bold", color: "blue" }}>TaxMate</span>와
            경제의 맛을 알아보세요!
          </h3>
